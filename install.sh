#!/usr/bin/env sh
# Universal installer for canzap. Prefers uv > pipx > pip; installs from the repo.
set -e
SRC="git+https://github.com/cognis-digital/canzap.git"
echo "Installing canzap ..."
