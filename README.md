...
```bash
pip install "git+https://github.com/cognis-digital/canzap.git"
...
`canzap` is source-available (not published to PyPI) — every method below installs
straight from GitHub. Pick whichever you prefer; the one-line scripts auto-detect
the best tool available on your machine.

**One-liner (Linux / macOS):**
```sh
curl -fsSL https://raw.githubusercontent.com/cognis-digital/canzap/HEAD/install.sh | sh
```

**One-liner (Windows PowerShell):**
```powershell
irm https://raw.githubusercontent.com/cognis-digital/canzap/HEAD/install.ps1 | iex
```

**Or install manually — any one of:**
```sh
pipx install "git+https://github.com/cognis-digital/canzap.git"     # isolated (recommended)
uv tool install "git+https://github.com/cognis-digital/canzap.git"  # uv
pip install "git+https://github.com/cognis-digital/canzap.git"      # pip
```

**From source:**
```sh
git clone https://github.com/cognis-digital/canzap.git
cd canzap && pip install .
```
